...
from price_monitoring.telegram.models import (
    InlineButton,
...
async def main() -> None:
    ...
    try:
        ...
        logger.error("Invalid TELEGRAM_WHITELIST format. Expected comma-separated list of integers.")
        return
    ...
    try:
        ...
        # Create whitelist
        simple_whitelist = SimpleWhitelist(whitelist)
